...
public class Bookingchoice extends FragmentActivity implements com.appsaga.provizo.ProfileDialog.DialogListener, OnMapReadyCallback,
    ...
    private void fetchLastLocation() {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED&&locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
